...
5. Optional tag: `git tag -a dlc-YYYYMMDD -m "Snapshot after <feature>"`.
6. Rollback only with approval: single file `git restore <file>`; whole repo resets require user ok.

Backups
- Existing: `team_cli_v3.py.bak` (2025-12-15), `team_cli_dlc.py.bak` (2025-12-17). Keep .bak for major versions; .gitignore excludes them.
