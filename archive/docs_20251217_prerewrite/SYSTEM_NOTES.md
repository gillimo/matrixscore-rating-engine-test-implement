...
-   **Filesystem:** work inside OneDrive Desktop (`teambuilder_v5`); `PERMISSIONS.md` is the authoritative inherited-permissions-source; include footer (`Permissions: full access to OneDrive/Desktop/teambuilder_v5 granted by user on 2025-12-17.`) on logs.
