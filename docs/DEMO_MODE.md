...
- Command: `echo "finalize" | python team_cli_v5.py`
- Behavior: starts empty, autofills to 6, then moves/GUI if available.
- Logging: writes to `logs/demo_<timestamp>.log`; include footer `Permissions: full access to OneDrive/Desktop/teambuilder_v5 granted by user on 2025-12-17.` and sign with your handle.
